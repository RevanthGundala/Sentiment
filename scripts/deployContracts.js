...
async function main() {
  ...
  args = [SEPOLIA_FUNCTIONS_ORACLE_ADDRESS, verifierContract.address, MERKLE_TREE_HEIGHT, poseidonContract.address, VRFv2SubscriptionManagerContract.address, SUB_ID, FULFILL_GAS_LIMIT]
